...
const Restracard = (props) => {
    ...
    return (
        <div data-testid="restraCard" className="m-4 p-4 rounded-lg shadow-lg w-[250px]  bg-gray-200 transition-transform transform  hover:scale-110 hover:cursor-pointer"
            >
            <img 
